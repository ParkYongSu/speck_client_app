...
class CashWithdrawResult extends StatelessWidget {
  final String amount;

  CashWithdrawResult({Key key, this.amount}) : super(key: key);
  ...
  Widget _result(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: <Widget>[
          Text("총 $amount원의 캐시가", style: TextStyle(fontSize: _uiCriteria.textSize4, fontWeight: FontWeight.w700, color: mainColor, letterSpacing: 0.9),),
