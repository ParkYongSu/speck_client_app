...
class MainHomeState extends State<MainHome> with WidgetsBindingObserver {
            ...
            child: GestureDetector(
              ...
              child: Container(
                decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: Colors.white.withOpacity(0.5), blurRadius: 20, spreadRadius: 0, offset: Offset(0, 3))],
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                        alignment: Alignment.center,
                        child: Text("닫기", style: TextStyle(color: Colors.white, fontSize: uiCriteria.textSize2, fontWeight: FontWeight.w700, letterSpacing: 1.12),)),
                  ),
                ),
              ],
            ),
  ...
  void _noToday() async {
    var url = Uri.parse("$speckUrl/home/banner");
    String body = '''{
