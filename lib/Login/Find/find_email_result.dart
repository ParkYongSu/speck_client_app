  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar(
          toolbarHeight: _uiCriteria.totalHeight * 0.067,
          elevation: 0,
                  ...
                  child: Column(
                      ...
                      children: <Widget>[
                        Column(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: <Widget>[
                              Text("회원님의 휴대전화로", style: TextStyle(letterSpacing: 0.9, color: mainColor, fontSize: _uiCriteria.textSize4, fontWeight: FontWeight.w700)),
                              AspectRatio(aspectRatio: 343/9),
                              Text("가입한 이메일이 있어요.", style: TextStyle(letterSpacing: 0.9, color: mainColor, fontSize: _uiCriteria.textSize4, fontWeight: FontWeight.w700)),
                            ]
                        ),
                                        ...
                                        children: <Widget>[
                                          ...
                                          Consumer<FindState>(
                                            builder: (context, state, child) {
                                              return Row(
                                                children: <Widget>[
                                                  Text("본인인증  ", style: TextStyle(letterSpacing: 0.5,color: mainColor, fontSize: _uiCriteria.textSize5, fontWeight: FontWeight.w500)),
                                                  Container(
                                                    height: _uiCriteria.screenWidth * 0.027,
                                                    width: 1,
                                                    color: greyD8D8D8,
                                                  ),
                                                  Text("  ${state.getRegisterDate()} 가입", style: TextStyle(letterSpacing: 0.5, color: mainColor, fontSize: _uiCriteria.textSize5, fontWeight: FontWeight.w500))
                                                ],
                                              );
